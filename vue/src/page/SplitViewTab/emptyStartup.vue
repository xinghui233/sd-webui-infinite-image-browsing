        ...
        <ul>
          ...
          <template
            ...
            <actionContextMenu v-for="t in toLaunchModes(dir.types)" :key="t"
              @open-in-new-tab="openInNewTab('local', dir.dir, t, t === 'normale_walk' ? dir.normalWalkStartDepth : undefined)"
              @open-on-the-right="openOnTheRight('local', dir.dir, t, t === 'normale_walk' ? dir.normalWalkStartDepth : undefined)">

              <li class="item rem" @click.prevent="openInCurrentTab('local', dir.dir, t, t === 'normale_walk' ? dir.normalWalkStartDepth : undefined)">
